...
from deepagents.tools.registry import tool_description, tool_name
from deepagents.tools.types import ToolDescriptor, ToolRisk
...
async def aload_mcp_tools(config: AgentRuntimeConfig) -> LoadedMCPTools:
    ...
    try:
        ...
        msg = "Install `langchain-mcp-adapters` or `deepagents[runtime]` to use MCP tools."
