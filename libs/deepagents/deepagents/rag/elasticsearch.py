...
from deepagents.rag.metadata import ChunkMetadata, RetrievalScope, Visibility
...
class ElasticsearchKeywordStore:
    ...
    client in tests, or install `deepagents[rag]` for the production client.
    """
...
def _build_client(url: str) -> _ElasticsearchClient:
    if _Elasticsearch is None:
        msg = "Install `deepagents[rag]` or pass an Elasticsearch client."
