...
from deepagents.tasks.types import TaskEventRecord, TaskEventType, TaskIntent, TaskRecord, TaskStatus, TaskStepKind, TaskStepRecord, TaskStepStatus

if TYPE_CHECKING:
    from collections.abc import Iterator
    from contextlib import AbstractContextManager

    from deepagents.tools.types import ToolRisk
