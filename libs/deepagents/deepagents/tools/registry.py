...
from deepagents.tools.types import ToolDescriptor, ToolRisk, ToolSource
...
def default_tool_registry(*, unknown_tool_risk: ToolRisk = "read_only") -> ToolRegistry:
    """Create a registry with Deep Agents built-in tools classified.
...
def _builtin_descriptors() -> list[ToolDescriptor]:
    return [
        *[
            ToolDescriptor(
                name=name,
                description="Read-only Deep Agents built-in tool.",
                risk="read_only",
                source="builtin",
            )
        ...
        *[
            ToolDescriptor(
                name=name,
                description="Write-capable Deep Agents built-in tool.",
                risk="write",
                source="builtin",
        ...
        *[
            ToolDescriptor(
                name=name,
                description="High-risk Deep Agents built-in tool.",
                risk="destructive",
                source="builtin",
